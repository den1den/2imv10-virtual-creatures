...
namespace VirtualCreatures {
    ...
    public class CreatureScript : MonoBehaviour {
        ...
        public static CreatureScript construct(Morphology morphology, Vector3 position)
        {
            return CreatureScript.construct(morphology, position, Quaternion.identity);
        }
        ...
        public static CreatureScript construct(Morphology morphology, Vector3 position, Quaternion rotation)
        {
            ...
            CreatureScript result = superInstance.GetComponent<CreatureScript>();
            ...
            result.setReferences(neuralNetwork);
